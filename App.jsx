      ...
      <aside className="sidebar">
        <div className="brand-card">
          ...
          <div>
            ...
            <h1>Óticas Fácil</h1>
            <p className="muted">Painel empresarial com controle de caixa diário e fechamento por responsável.</p>
          </div>
        </div>
      ...
      <main className="content">
        <header className="topbar enterprise">
          <div>
            ...
            <p className="subtext">Organização diária do caixa, lançamentos e fechamento por data.</p>
          </div>
        ...
        <section className="daily-grid">
          <div className="panel daily-panel">
            ...
            <div className="fechamento-box">
              <div className="fechamento-head">
                <div>
                  <h4>Fechamento de caixa diário</h4>
                  <p>Ao fechar o caixa, os lançamentos desse dia ficam bloqueados para alteração.</p>
                </div>
              </div>
              ...
              <div className="form-grid">
                <label className="field">
                  ...
                  <select value={fechamentoPor} onChange={(e) => setFechamentoPor(e.target.value)} disabled={!!fechamentoDoDia}>
                ...
                <label className="field field-full">
                  ...
                  <textarea
                    ...
                    placeholder="Ex.: caixa conferido com valores em mãos"
                    disabled={!!fechamentoDoDia}
                  />
                </label>
              </div>
              ...
              {fechamentoDoDia ? (
                <div className="closed-info">
                  ...
                  <span>em {formatDate(fechamentoDoDia.data)} • saldo fechado {formatMoney(fechamentoDoDia.saldo)}</span>
                </div>
              ) : (
                <button className="primary-btn" type="button" onClick={fecharCaixa} disabled={fechando}>
                  {fechando ? 'Fechando caixa...' : 'Fechar caixa do dia'}
                </button>
              )}
            </div>
          </div>
          ...
          <div className="panel mini-panel">
            ...
            <div className="mini-list">
              {fechamentos.length === 0 ? (
                <div className="empty-state small-empty">Nenhum fechamento realizado.</div>
              ) : (
                fechamentos.slice(0, 5).map((item) => (
                  <div className="mini-row" key={item.id}>
                    <div>
                      <div className="mini-title">{formatDate(item.data)}</div>
                      <div className="mini-meta">Fechado por {item.fechado_por}</div>
                    </div>
          ...
          <form className="panel form-panel" onSubmit={submitForm}>
            <div className="panel-head">
              <div>
                ...
                <p>Cadastre entradas e saídas com padrão mais corporativo e controle por data.</p>
              </div>
              {editandoId ? (
