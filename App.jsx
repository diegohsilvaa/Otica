...
export default function App() {
  ...
  async function handleLogin(emailDigitado) {
    ...
    const { data, error } = await supabase
      .from('empresas')
      .select('id, nome, codempresa, email_acesso, ativo')
      .eq('ativo', true)
      .ilike('email_acesso', emailNormalizado)
      .maybeSingle()
    ...
    localStorage.setItem('otica_empresa', JSON.stringify(data))
    setEmpresaAtual(data)
    setForm(emptyForm(hoje, data.codempresa))
    setAuthLoading(false)
  }
