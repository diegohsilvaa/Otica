...
export default function App() {
  ...
  function editarFinanceiro(item) {
    setFinanceiroForm({ ...emptyFinanceiro(), ...item, valor_total: String(item.valor_total ?? ''), valor_quitado: String(item.valor_quitado ?? '') })
