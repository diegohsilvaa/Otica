  ...
  if (!empresaAtual) {
    return (
      <div className="auth-shell">
        <div className="auth-card auth-card-wide auth-card-visual">
          <div className="auth-side">
            <p className="page-kicker orange-text">Acesso</p>
            <h1>Gestão inteligente para óticas</h1>
            <p className="auth-text">Um ambiente elegante, moderno e pensado para a rotina da ótica.</p>
            <div className="auth-visual-stack">
              ...
              <div className="auth-mini-copy">
                <strong>Visão, atendimento e organização em um só painel.</strong>
                <span>Entre com o email autorizado para acessar seu ambiente.</span>
              </div>
            </div>
          </div>
          <form className="auth-form-card" onSubmit={handleLogin}>
            <div>
              ...
              <p className="auth-form-text">Acesso rápido ao painel da sua ótica.</p>
            </div>
            ...
            <button className="primary-btn auth-submit-btn" type="submit" disabled={loginLoading}>{loginLoading ? 'Entrando...' : 'Acessar painel'}</button>
          </form>
        </div>
      </div>
    )
