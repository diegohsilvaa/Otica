...
export default function App() {
  ...
  async function fetchLancamentos() {
    ...
    if (error) {
      setErro('Não foi possível carregar os lançamentos. Verifique a tabela e as variáveis do Supabase.')
      setLoading(false)
      return
    }
  ...
  async function submitForm(e) {
    ...
    if (editandoId) {
      ...
      if (error) {
        setErro('Não foi possível atualizar o lançamento.')
        setSalvando(false)
        return
      }
    } else {
  ...
  async function excluir(id) {
    ...
    if (error) {
      setErro('Não foi possível apagar o lançamento.')
      return
    }
      ...
      <aside className="sidebar">
        <div className="brand-card">
          ...
          <div>
            ...
            <h1>Óticas Fácil</h1>
            <p className="muted">Controle financeiro com banco online no Supabase.</p>
          </div>
        </div>
        ...
        <div className="highlight-card">
          ...
          <p className="muted dark-text">Agora os dados ficam online e acessíveis em qualquer dispositivo.</p>
        </div>
      </aside>
      ...
      <main className="content">
        ...
        <section className="stats-grid">
          ...
          <div className="stat-card">
            ...
            <p>{loading ? 'Carregando...' : 'Sincronizado com o banco.'}</p>
          </div>
        </section>
