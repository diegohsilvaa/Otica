...
function HomeScreen({ onOpen }) {
  return (
    <div className="welcome-shell">
      <div className="welcome-content home-content">
        ...
        <div className="welcome-card">
          <p className="welcome-kicker">Painel inicial</p>
          <h2>Escolha a área que deseja acessar</h2>
          <p className="welcome-text">Essa tela inicial evita que o sistema abra direto no fluxo de caixa. O acesso por email será adicionado depois.</p>

          <div className="home-actions-grid">
            <button type="button" className="home-nav-card" onClick={() => onOpen('clientes')}>
              <small>Cadastro</small>
              <strong>Clientes</strong>
              <span>Abra a ficha de clientes e realize novos cadastros.</span>
            </button>

            <button type="button" className="home-nav-card" onClick={() => onOpen('fluxo-caixa')}>
              <small>Financeiro</small>
              <strong>Fluxo de Caixa</strong>
              <span>Acesse o livro caixa e as movimentações financeiras.</span>
            </button>
          </div>
...
export default function App() {
  ...
  if (screen === 'home') {
    return <HomeScreen onOpen={(destino) => { setAbaAtual(destino === 'fluxo-caixa' ? 'fluxo-caixa' : 'clientes'); setScreen('app') }} />
  }
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <div className="menu-card">
          ...
          <button type="button" className={abaAtual === 'fluxo-caixa' ? 'menu-item active menu-button' : 'menu-item menu-button'} onClick={() => setAbaAtual('fluxo-caixa')}>Fluxo de Caixa</button>
          <button type="button" className="menu-item menu-button" onClick={() => setScreen('home')}>Página Inicial</button>
        </div>
      ...
      <main className="content">
        ...
        {abaAtual === 'fluxo-caixa' ? (
          ...
          <>
            <header className="topbar">
              <div><p className="page-kicker">Cadastro</p><h2>Clientes</h2><p className="topbar-subtitle">Código gerado pelo banco e sem edição pelo usuário.</p></div>
            </header>
            <section className="main-grid clientes-grid">
              <form className="panel featured-form" onSubmit={submitCliente}>
                <div className="panel-head"><div><span className="badge-title">Novo cadastro</span><h3>Cadastrar cliente</h3><p>O código é gerado automaticamente pelo banco de dados.</p></div></div>
